<script lang="ts">
    ...
    function redirectToGraf() {
    window.location.href = '/graf';
  }
      ...
      <div class="table bg-[#003941] h-[544px] w-[1020px] rounded-[56px] px-5 py-5">
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="flex gap-3">
            ...
            <button class="font-euclid_circular_a inline-flex items-center justify-center gap-3 rounded-[9000px] hover:bg-[#BAF400] bg-[#14142B] px-4 py-2.5 font-normal text-[#FCFCFC] transition-all" on:click={redirectToGraf}>
